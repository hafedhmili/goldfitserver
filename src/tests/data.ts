...
function createSomeData  () {
    ...
    const eSeries2 = new ExerciseSeries('Ex13', 'Exercises 1 and 3');
    eSeries2.addExercice(ex1,{min: 2, max: 4},1)
    eSeries2.addExercice(ex3,{min: 2, max: 5},2)
  
    const eSeries3 = new ExerciseSeries('Ex123', 'Exercises 1, 2 and 3');
    ...
    const program1 = new Program('PACE','This is the pace program',60);
    program1.addExerciseSeries(new Interval(1,60),eSeries3);
  ...
  export default {createSomeData:createSomeData,testDataAccess:testDataAccess}