...
SHOW WARNINGS;
CREATE INDEX `fk_exercise_series_id_idx` ON `GoldFit`.`ProgramExerciceSeries` (`ExerciceSeriesId` ASC) VISIBLE;
...
SHOW WARNINGS;
CREATE INDEX `fk_ExerciseId_idx` ON `GoldFit`.`ExerciceSeriesExercice` (`ExerciceId` ASC) VISIBLE;

SHOW WARNINGS;
CREATE INDEX `fk_ExerciseSeriesId_idx` ON `GoldFit`.`ExerciceSeriesExercice` (`ExerciceSeriesId` ASC) VISIBLE;
...
SHOW WARNINGS;
CREATE INDEX `fk_program_enrollment_idx` ON `GoldFit`.`ProgramDayRecord` (`ProgramEnrollmentId` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `GoldFit`.`ExerciceRecord` (
  `idExerciceRecord` SMALLINT(2) UNSIGNED NOT NULL,
...
SHOW WARNINGS;
CREATE INDEX `fk_program_day_record_idx` ON `GoldFit`.`ExerciceRecord` (`ProgramDayRecordId` ASC) VISIBLE;

SHOW WARNINGS;
CREATE INDEX `fk_exerice_idx` ON `GoldFit`.`ExerciceRecord` (`ExerciceId` ASC) VISIBLE;
